...
builder.Services.AddCors(options =>
{
    options.AddPolicy(name: "debug",
        ...
        {
            policy
            .WithOrigins("http://localhost", "http://localhost:4200", "https://localhost", "https://localhost:4200")
            .AllowCredentials()
            .AllowAnyMethod()
            .AllowAnyHeader();
        });
    options.AddPolicy(name: "prod",
        ...
        {
            policy
            .WithOrigins("http://localhost", "https://localhost", "http://127.0.0.1", "https://127.0.0.1", "http://192.168.0.1", "https://192.168.0.1")
            .AllowCredentials()
            .AllowAnyMethod()
            .AllowAnyHeader();
        });
